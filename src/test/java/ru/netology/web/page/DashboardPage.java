...
public class DashboardPage {
    ...
    public int getFirstCardBalance() {                            // method will be modified
        val text = cards.first().text();
        return extractBalance(text);
    }

    public int getSecondCardBalance() {                           // method will be modified
        val text = cards.last().text();
        return extractBalance(text);
    }

    private int extractBalance(String text) {                     // method will be modified
